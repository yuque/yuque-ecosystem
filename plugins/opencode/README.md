...
> **团队版（group）已暂时下线**：其 skills 依赖的团队统计类 MCP 工具尚未在 `yuque-mcp` 中提供，待底层工具就绪后再重新上架。
...
> **维护说明：** 本目录下的 skills 是从 [`plugins/yuque-personal/skills/`](../yuque-personal/skills/)（唯一源）同步的副本，请勿直接修改。改动请提交到唯一源后运行 `npm run sync-skills`。
