...
const personalSkills = [
  // 📥 输入
  {
    ...
    category: '📥 输入',
    link: 'https://github.com/yuque/yuque-ecosystem/tree/main/skills/reading-digest',
  },
  {
    icon: '💡',
    title: '碎片捕捉',
    ...
    category: '📥 输入',
    link: 'https://github.com/yuque/yuque-ecosystem/tree/main/skills/daily-capture',
  },
  // 🧠 加工
  {
    icon: '✨',
    ...
    category: '🧠 加工',
    link: 'https://github.com/yuque/yuque-ecosystem/tree/main/skills/note-refine',
  },
  {
    icon: '🕸️',
    title: '知识关联',
    ...
    category: '🧠 加工',
    link: 'https://github.com/yuque/yuque-ecosystem/tree/main/skills/knowledge-connect',
  },
  {
    icon: '✍️',
    title: '风格提取',
    ...
    category: '🧠 加工',
    link: 'https://github.com/yuque/yuque-ecosystem/tree/main/skills/style-extract',
  },
  // 📤 输出
  {
    icon: '🔍',
    ...
    tags: ['search', 'get_doc'],
    category: '📤 输出',
    link: 'https://github.com/yuque/yuque-ecosystem/tree/main/skills/smart-search',
  },
  {
    icon: '📋',
    title: '智能摘要',
    ...
    category: '📤 输出',
    link: 'https://github.com/yuque/yuque-ecosystem/tree/main/skills/smart-summary',
  },
  // 🔄 维护
  {
    icon: '🔎',
    ...
    category: '🔄 维护',
    link: 'https://github.com/yuque/yuque-ecosystem/tree/main/skills/stale-detector',
  },
]
    ...
    <section className={styles.section} id="skills">
      ...
      <div className={styles.titleRow}>
        ...
        <a
          ...
          href="https://github.com/yuque/yuque-ecosystem/tree/main/skills"
          target="_blank"
